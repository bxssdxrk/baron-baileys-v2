...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        if (options.getProfilePicUrl) {
            ...
            if (pfpUrl) {
                const resp = await fetch(pfpUrl, { method: 'GET', dispatcher: (_a = options === null || options === void 0 ? void 0 : options.options) === null || _a === void 0 ? void 0 : _a.dispatcher });
                if (resp.ok) {
    ...
    if ('mentions' in message && ((_d = message.mentions) === null || _d === void 0 ? void 0 : _d.length)) {
